<template>
  <div class="animate" style="overflow: hidden;height: 100%;">
    <el-button v-show="showButton" :icon="showLeftBar?'el-icon-arrow-left':'el-icon-arrow-right'" :style="{float:'right',marginRight:'-5px',fontWeight: 'bold',width: '15px' ,paddingLeft: '5px',position:'absolute',zIndex:'1000',left:showLeftBar?(initLeftWidth-10+'px'):'-7px',top :clientHeight/2+'px' }" size="mini" type="primary" @click="handleSwitchType()" plain></el-button>
    <el-row :gutter="3" type="flex" justify="end">
      <el-col :style="{width: leftWidth+'px'}">
      ...
      <el-col :style="{width: clientWidth-leftWidth+'px',borderLeft: '2px solid #89DBFF'}">
